# リリースノート
## v1.6.3-9-2(2026/05/11)
- 起動時に地震情報が正しく表示されない問題の修正(2)
- 台湾のリアルタイム震度表示機能の設定が保存されない問題の修正
- 今後は更新を行わない予定です(2026/07/21 追記)
## v1.6.3-9(2026/05/10)
- 噴火情報の読み上げの問題修正と変更
- 起動時に存在しない地震情報が表示される問題の修正
- その他の問題を修正
- 台湾のリアルタイム震度を表示する機能の追加 出典:ExpTech API
## v1.6.3-8-10(2026/02/11)
- S-netの1分更新が正しく動作しない問題の修正
## v1.6.3-8-9(2026/01/25)
- 緊急地震速報の処理部分を一部変更
- 色の変更が適用/保存されない問題の修正
## v1.6.3-8-8(2026/01/12)
- 緊急地震速報(警報)の対象地域が読み上げられない問題を修正
- 効果音の変更が保存されない問題の修正
- リプレイがすぐに終了する問題の修正
## v1.6.3-8-7(2026/01/06)
- 緊急地震速報の推定最大震度が5-以上の時に震度不明になるバグを修正
## v1.6.3-8-6(2025/12/28)
- 緊急地震速報が受信できない問題の修正(2)
## v1.6.3-8-5(2025/12/27)
- カメラの問題を修正
- 震央地名の推定が「北西太平洋」などになるバグの修正(2)
## v1.6.3-8-4(2025/12/27)
- 緊急地震速報が受信できない問題の修正
## v1.6.3-8-3(2025/12/27)
- 緊急地震速報受信処理を一部調整
## v1.6.3-8-2(2025/12/27)
- その他の設定を閉じたときにスイッチが出たままになる問題の修正
- その他の設定の一部がバグってる問題の修正
- iOSやiPadOSで開けない問題の対処としてキャッシュ無効版の追加
## v1.6.3-8(2025/12/27)
- 海底震度計の1分更新によるバグを修正(多分)
- 猫警報音が警報発表時にならない問題の修正
- 緊急地震速報での予想震度に対応
- Wolfxから直接緊急地震速報を受信するように変更
- 年越しカウントダウンの追加
- 緊急地震速報の精度情報読み上げに対応
- 震央地名の推定が「北西太平洋」などになるバグの修正
